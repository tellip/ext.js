...
//     );
// };
Reflect.map = (obj, cb) => Object.entries(obj).reduce((acc, [key,value]) => {
...
Reflect.filter = (obj, cb) => Object.entries(obj).filter(([key,value]) => cb(value, key, obj)).reduce((acc, [key,value]) => {
    acc[key] = value;
    return acc;
}, {});
